export const FullPageLoading = () => {
  const SpanStyle = 'relative top-[30px] inline-block text-[4rem] text-primary';

  return (
    <article className="fixed top-0 bottom-0 left-0 right-0 bg-gray-500 bg-opacity-20 flex font-extrabold justify-center items-center z-50 shadow-['0 1px 0 #CCC, 0 2px #CCC, 0 3px #CCC, 0 4px #CCC, 0 5px #CCC, 0 6px transparent, 0 7px transparent, 0 8px transparent, 0 9px transparent, 0 50px 25px rgba(0, 0, 0, .4)'] select-none">
